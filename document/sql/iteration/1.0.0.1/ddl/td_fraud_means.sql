use intermediary;
create TABLE td_fraud_means  (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(255) NOT NULL DEFAULT '' COMMENT '手段名称',
  `frequency` int(10) NOT NULL DEFAULT 0 COMMENT '使用次数',
  ...
  PRIMARY KEY (`id`),
  KEY `index_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=1488440019246646006 DEFAULT CHARSET=utf8 COMMENT='欺骗手段';
